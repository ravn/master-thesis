...
\hline
  ...
  \end{center}
\end{figure}
which then returns the table shown in figure~\myvref{fig:mysql-tutorial-example-output}:
...
developing the Cactus system (see~\myvref{sec:cactus-choice-of-language}
