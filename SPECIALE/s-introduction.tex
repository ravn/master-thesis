...
\myurl{http://www.mozilla.org}{Mozilla project} has shown the benefit
...
terms are defined in \myvref{cha:terms-and-concepts}; figures, tables
and other sections are hyperlinked from the text to their actual
location (like this: see \myvref{fig:viggo-cactus}); bibliography
...
(\myurl{http://www.bigfoot.com/~thunderbear}{like this}) which may be
clicked upon directly inside the Adobe Acrobat Reader.  Note the
distinct colors of the links.

Note:  Due to the special status the tilde (\~{}) character has in
