...
Table~\myvref{tab:programming-langugages-and-html} shows how the most
frequently used acronyms relate when mapped to the programming domain.
See section~\myvref{cha:terms-and-concepts} for the full descriptions.
...
them.  Table~\myvref{tab:distribution-formats} discusses the current
...
longer use (see section~\myvref{sec:docbook-xml-to-rtf} for more
details). 
...
Table~\myvref{tab:leading-xslt-processors} lists the tested XSLT
...
described in chapter~\myvref{sec:cactus} \textsf{??}.
