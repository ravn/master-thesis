...
chapter~\myvref{cha:cactus-sample-set-of-filters} list a small
set of external filters I have implemented to provide
\textsf{....}, and
chapter~\myvref{cha:cactus-possible-candidates-for-filters}
...
Figure~\myvref{fig:gather} shows some of the possible ways to acquire
...
table~\myvref{tab:mysql-examiners}.  Figure~\myvref{fig:items}
