...
\item \textbf{Incompatible platforms} -- the CGI-programmer may not
  ...
  Recently Java Servlets (see \myvref{sec:java-servlets}) have
...
\myvref{sec:google}) was such an engine, and users quickly
...
which is described in \myvref{cha:cactus}, and which has been
fulfilled.
