...
Back in the old days when the world wide web was designed (1989), a web
...
\item \textbf{Incompatible platforms} -- the CGI-programmer may not
  ...
  Recently Java Servlets (see section~\vref{sec:java-servlets}) have
...
or W3C.  No such standard has arisen yet, but an XML-dialect will most
...
leave out either one.  \textsf{sample or explain more}
...
Programming}.  \textsf{Code rearrangement?}
