...
\myvref{fig:yahoo-1}) which started as a directory over
...
\myvref{sec:literate-programming}).  The only other publicized
...
estate (the Nokia 9110 is shown in \myvref{fig:nokia-1}) so such
