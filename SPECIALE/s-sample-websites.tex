...
as mentioned in
section~\vref{sec:map-generation-first-web-application}.  In Denmark,
...
shown in figure~\vref{fig:krak-1}, and is seperated in two parts;
...
map is shown (see figure~\vref{fig:krak-4}), where it is evident that
...
This map is shown in figure~\vref{fig:krak-5b} (and explained in words
in figure~\vref{fig:krak-6}), and is perfectly adequate for a person
...
\myimage{gr/krak-6}{The route in figure~\vref{fig:krak-5b} explained
  in words}{krak-6}
...
\item A set of right and left side panes for the navigation.  Clicking
  a link (like those shown in figure~\vref{fig:yggdrasil-1}) changed
...
project, as discussed in chapter~\vref{cha:cactus}.
